...
- **Фаза**: 3 (Документооборот) — задачи 3.1–3.10 готовы
- **Последняя сессия**: 2026-07-16 — задача 3.10 (ДСП: право+допуск-список, скрытие из поиска, read_log, редакция уведомлений)
- **Ветка**: main
...
| 3 Документооборот | 🟡 задачи 3.1–3.10 готовы      | —                  |
| 4 Задачи          | ⬜                           | —                  |
| 5 Чат             | ⬜                           | —                  |
| 6 Звонки          | ⬜                           | —                  |
| 7 Hardening       | ⬜                           | —                  |
