...
- **Фаза**: 3 (Документооборот) — задачи 3.1–3.2 готовы
- **Последняя сессия**: 2026-07-15 — задача 3.2 (documents/document_files, статусная машина, кабинет ДОУ + карточка)
- **Ветка**: main
...
| 3 Документооборот | 🟡 задачи 3.1–3.2 готовы       | —                  |
| 4 Задачи          | ⬜                           | —                  |
| 5 Чат             | ⬜                           | —                  |
| 6 Звонки          | ⬜                           | —                  |
| 7 Hardening       | ⬜                           | —                  |
