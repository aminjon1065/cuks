...
- **Фаза**: 3 (Документооборот) — задачи 3.1–3.8 готовы
- **Последняя сессия**: 2026-07-15 — задача 3.8 (контроль исполнения: представление «На контроле», deadlines-cron с напоминаниями/эскалациями, продление/снятие с контроля)
- **Ветка**: main
...
| 3 Документооборот | 🟡 задачи 3.1–3.8 готовы       | —                  |
| 4 Задачи          | ⬜                           | —                  |
| 5 Чат             | ⬜                           | —                  |
| 6 Звонки          | ⬜                           | —                  |
| 7 Hardening       | ⬜                           | —                  |
