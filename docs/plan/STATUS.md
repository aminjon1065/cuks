...
- **Фаза**: 3 (Документооборот) — задачи 3.1–3.9 готовы
- **Последняя сессия**: 2026-07-15 — задача 3.9 (отчёт исполнительской дисциплины: агрегация по подразделениям/исполнителям, JSON + XLSX-экспорт)
- **Ветка**: main
...
| 3 Документооборот | 🟡 задачи 3.1–3.9 готовы       | —                  |
| 4 Задачи          | ⬜                           | —                  |
| 5 Чат             | ⬜                           | —                  |
| 6 Звонки          | ⬜                           | —                  |
| 7 Hardening       | ⬜                           | —                  |
