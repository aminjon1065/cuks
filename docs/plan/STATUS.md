...
- **Фаза**: 3 (Документооборот) — задачи 3.1–3.7 готовы
- **Последняя сессия**: 2026-07-15 — задача 3.7 (UI: очереди с прямыми действиями, 5-вкладочная карточка, мастер регистрации, журналы+печать)
- **Ветка**: main
...
| 3 Документооборот | 🟡 задачи 3.1–3.7 готовы       | —                  |
| 4 Задачи          | ⬜                           | —                  |
| 5 Чат             | ⬜                           | —                  |
| 6 Звонки          | ⬜                           | —                  |
| 7 Hardening       | ⬜                           | —                  |
