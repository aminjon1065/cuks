...
- **Фаза**: 5 (Чат) — в работе; задачи 5.1–5.4 готовы. Фаза 4 завершена (4.1–4.6).
- **Последняя сессия**: 2026-07-16 — задача 5.4 (непрочитанные/бейджи/разделитель «Новые», typing, presence + ревью)
- **Ветка**: main
