...
- **Фаза**: 3 (Документооборот) — задачи 3.1–3.11 готовы
- **Последняя сессия**: 2026-07-16 — задача 3.11 (замещения в маршрутах: заместитель видит/исполняет/подписывает «за», период-модель, аудит)
- **Ветка**: main
...
| 3 Документооборот | 🟡 задачи 3.1–3.11 готовы      | —                  |
| 4 Задачи          | ⬜                           | —                  |
| 5 Чат             | ⬜                           | —                  |
| 6 Звонки          | ⬜                           | —                  |
| 7 Hardening       | ⬜                           | —                  |
