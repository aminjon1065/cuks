...
- **Фаза**: 2 (ГИС/аналитика) — задачи 2.1–2.7 готовы
- **Последняя сессия**: 2026-07-15 — задача 2.7 (инспектор объектов, рисуемые слои, terra-draw)
- **Ветка**: main
...
| 2 ГИС/аналитика   | 🟡 задачи 2.1–2.7 готовы       | —                  |
| 3 Документооборот | ⬜                           | —                  |
| 4 Задачи          | ⬜                           | —                  |
| 5 Чат             | ⬜                           | —                  |
| 6 Звонки          | ⬜                           | —                  |
