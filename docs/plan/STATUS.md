...
- **Фаза**: 3 (Документооборот) — задачи 3.1–3.5 готовы
- **Последняя сессия**: 2026-07-15 — задача 3.5 (ЭЦП: CA, сертификаты устройств, подпись/проверка, штамп-PDF)
- **Ветка**: main
...
| 3 Документооборот | 🟡 задачи 3.1–3.5 готовы       | —                  |
| 4 Задачи          | ⬜                           | —                  |
| 5 Чат             | ⬜                           | —                  |
| 6 Звонки          | ⬜                           | —                  |
| 7 Hardening       | ⬜                           | —                  |
